...
public class JavaFX07 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        button.setOnAction(e -> {
            ...
            double media = 0;
            Double notaAlumnoMax = null, notaAlumnoMin = null;
            for (NotaAlumno n : listaNotas.getItems()) {
                media += n.nota;
                if (notaAlumnoMax == null || n.nota > notaAlumnoMax) {
                    notaAlumnoMax = n.nota;
                }
                if (notaAlumnoMin == null || n.nota < notaAlumnoMin) {
                    notaAlumnoMin = n.nota;
                }

                media /= listaNotas.getItems().size();
                lblEstadisticas.setText("La nota media es " + media + ". La nota mínima es " + notaAlumnoMin + " y la nota máxima es " + notaAlumnoMax);
            }
        });
